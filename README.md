...
This repository provides the code, datasets, and supporting resources associated with the paper “Integrating Bitcoin Transactions into Relational Databases for IoT: Challenges and Solutions,” by Rebeca Tonu, Otilia Muntean, and Ciprian Pungilă. The work investigates the challenges of extracting, processing, and integrating Bitcoin blockchain data into a relational database designed for IoT-oriented analysis. It provides a reproducible workflow for retrieving blockchain data from Bitcoin-based blockchain, organizing it according to the proposed relational schema, and evaluating its query performance through empirical IoT-oriented scenarios.
